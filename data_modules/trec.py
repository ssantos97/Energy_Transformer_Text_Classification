...
class TRECDataModule(BaseDataModule):
    ...
    def __init__(self, d_params: dict):
        ...
        # hard-coded stuff
        self.path = "trec"  # hf_datasets will handle everything
        self.is_multilabel = True
        self.nb_classes = 6  # neg, pos
    ...
    def _collate_fn(self, samples: list, are_samples_batched: bool = False):
        ...
        # stack labels
        labels = collated_samples["coarse_label"]
    ...
    def setup(self, stage: str = None):
        ...
        modified_dataset = hf_datasets.load_dataset("trec")["train"].train_test_split(
            test_size=0.1
        )
        ...
        self.dataset.set_format(
            type="torch",
            columns=["input_ids", "coarse_label"],
